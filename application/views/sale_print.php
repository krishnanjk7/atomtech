...
<!--<div style="height:261.734px;width:100%;"></div> -->
			...
			<table class="table" style="margin:0px">
				<thead>
					<tr>
						<th colspan="10" style="text-align:center;font-size: 34px;font-family:Montserrat">TAX INVOICE</th>
					</tr>
					<tr>
						<th colspan="5" style="text-align:left;font-size: 16px;">
							<b>ATOM TECH</b><br/>
						...
						<th colspan="5" style="text-align:left;font-size:16px;vertical-align:top">
								<span style="font-size:20px;font-family:Montserrat">Billed to : </span><br/><br/>
					...
					<tr style="height:40px">
						<th colspan="5" style="vertical-align: middle;font-size:17px;width: 50%;">
			...
			<table class="table" style="margin:0px">
				<thead> -->
					<tr>
						...
						<th class="text-center bg-shade foot_bold" style="vertical-align: middle;" rowspan="2">TAXABLE AMOUNT</th>
						<th class="text-center bg-shade foot_bold" style="" colspan="2">SGST</th>
						<th class="text-center bg-shade foot_bold" style="" colspan="2">CGST</th>
						<th class="text-center bg-shade foot_bold" style="vertical-align: middle;" rowspan="2" >TOTAL</th>
					</tr>
					<tr>
						
						<th class="text-center bg-shade foot_bold" style="">%</th>
						<th class="text-center bg-shade foot_bold" style="">Amt</th>
						<th class="text-center bg-shade foot_bold" style="">%</th>
						<th class="text-center bg-shade foot_bold" style="">Amt</th>
					</tr>
				</thead>
			...
			-->
				<tfoot>
					<tr>
						...
						<th class="text-right"> <?php echo rupeeformat($sale["subtotal3"]); ?></th>
					</tr>
					<tr>
						<th rowspan="2" colspan="3" style="font-size:15px;">
							Acc.No : 58460200000021<br/>
							IFSC : BARB0AVINAS<br/>
							BANK OF BARODA, AVINASHI
						</th>
						<th colspan="6" class="foot_bold" style="text-align:right">TOTAL TAXABLE AMOUNT</th>
						<th class="text-right"><?php echo rupeeformat($sale["subtotal2"]); ?></th>
					</tr>
					<tr>
						<th colspan="6" class="foot_bold" style="text-align:right">TOTAL GST</th>
						<th class="text-right"><?php echo rupeeformat($sale["total_sgst"]+$sale["total_cgst"]+$sale["total_igst"]); ?></th>
					</tr> 
					<tr>
						<th rowspan="3" colspan="3" class="mont" style="font-size: 14px;"> <?php echo getIndianCurrency(floatval($sale["grand_total"])); ?> </th>
						<th colspan="6" class="foot_bold" style="text-align:right">SUB TOTAL</th>
						<th class="text-right " style=""><?php echo rupeeformat($sale["subtotal3"]); ?></th>
					</tr>
					<tr>
						<th colspan="6" class="foot_bold" style="text-align:right">ROUND OFF</th>
						<th class="text-right " style=""><?php echo rupeeformat($sale["roundoff"]); ?></th>
					</tr>
					<tr>
						<th colspan="6" class="foot_bold" style="text-align:right">GRAND TOTAL</th>
