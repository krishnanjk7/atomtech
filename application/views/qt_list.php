<?php include "admin_header.php"; ?>
	...
	<section class="content-header">
		<h1>Quotation<small>List</small></h1>
		<ol class="breadcrumb">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="box box-primary">
					...
					<a href="<?php echo base_url(); ?>index.php/Home/addQt">
						<input class="btn btn-primary" type="button" value="Add New Quotation"/>
					</a>
					<hr/>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="<?php echo base_url(); ?>index.php/Home/QtPrint?id=<?php echo $row["sale_id"];?>" target="_blank">
										<button type="button" class="btn btn-success">PRINT</button>
									</a> 
									
									
									<a href="<?php echo base_url(); ?>index.php/Home/updateQt?id=<?php echo $row["sale_id"];?>">
										<button type="button" class="btn btn-primary">EDIT</button>
									</a>
									
									
									<!--
									<a href="<?php echo base_url(); ?>index.php/Home/removePurchase?id=<?php echo $row["sale_id"];?>">
