<?php include "admin_header.php"; ?>
	...
	<section class="content-header">
		<h1>Purchase Account Statement<small>Report</small></h1>
		<ol class="breadcrumb">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="box box-primary">
					...
					<form action="<?php echo base_url()."index.php/Report/printPurchaseReport" ?>" method="GET" target="_blank">
					
						<div class="col-lg-12" style="margin-top:5px;border:2px solid grey;padding:3px;border-radius:4px">
							<div class="col-lg-6">
								<label class="col-lg-12">Dealer Name</label>
								<div class="col-lg-12">
