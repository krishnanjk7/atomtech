...
body {
  ...
  -moz-osx-font-smoothing: grayscale;      
	...
	<div class="login-page">
		<div class="form">
			<form class="register-form" action="<?php echo base_url()?>index.php/auth/create_user" method="post">
				...
				<input type="text" name="identity" value="" id="identity" placeholder="Mobile">
				<input type="text" name="email" value="" id="email" placeholder="Email">
				<input type="hidden" name="phone" value="" id="phone" placeholder="phone">
