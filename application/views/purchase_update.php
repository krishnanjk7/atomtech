...
.newproduct{
	...
	<section class="content-header">
		<h1>Purchase<small>Edit</small></h1>
		<ol class="breadcrumb">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="box box-primary">
					...
					<form role="form" action="<?php echo base_url()."index.php/Home/updatePurchase"; ?>" method="POST" id="purchase_form">
						<div class="box-body">
							...
							<table class="table table-bordered">
								<thead>
									<tr>
										...
										<th colspan="3">
											<select class="addcompany" name="company_id" required >
												...
												?>
													<option value="<?php echo $row["id"];?>" <?php if($purchase["company_id"]==$row["id"]){ echo "selected"; } ?>><?php echo $row["company_name"];?></option>
												<?php } } ?>
											</select>
										</th>
									</tr>
									<tr>
										<th>Invoice No</th>
										<th><input type="text" name="invoice_no" value="<?php echo $purchase["invoice_no"]; ?>"/></th>
										<th>Invoice Date</th>
										<th><input class="datepicker" type="text" name="invoice_date" value="<?php echo date("d-m-Y",strtotime($purchase["invoice_date"])); ?>"/></th>
									</tr>
									<tr>
										<th style="vertical-align:middle">Remarks</th>
										<th colspan="3"><textarea cols="50" rows="5" name="remarks"><?php echo $purchase["remarks"]; ?></textarea></th>
									</tr>
								</thead>
							...
							<table class="table table-bordered">
								...
								<tbody id="main_body">
									<?php foreach($purchase_group as $group) { ?>
									<tr>
										<td>
						...
						<div class="box-footer">
							...
							<table class="table table-bordered">
								<thead>
									...
									<tr>
										<th>Sub Total - I</th>
										<th><input type="text" id="sub_total1" name="sub_total1" value="<?php echo $purchase["subtotal1"]; ?>" readonly />
										</th>
									</tr>
									<tr>
										<th>Discount</th>
										<th><input type="number" id="total_discount" name="total_discount" value="<?php echo $purchase["discount"]; ?>" readonly /></th>
									</tr>
									<tr>
										<th>Sub Total - II</th>
										<th><input type="number" id="sub_total2" name="sub_total2" value="<?php echo $purchase["subtotal2"]; ?>" readonly /></th>
									</tr>
									<tr>
										<th>Total CGST </th>
										<th><input type="text" id="total_cgst" name="total_cgst" value="<?php echo $purchase["total_cgst"]; ?>" readonly /></th>
									</tr>
									<tr>
										<th>Total SGST </th>
										<th><input type="text" id="total_sgst" name="total_sgst" value="<?php echo $purchase["total_sgst"]; ?>" readonly /></th>
									</tr>
									<tr>
										<th>Total IGST </th>
										<th><input type="text" id="total_igst" name="total_igst" value="<?php echo $purchase["total_igst"]; ?>" readonly /></th>
									</tr>
									<tr>
										<th>Sub Total - III</th>
										<th><input type="text" id="sub_total3" name="sub_total3" value="<?php echo $purchase["subtotal3"]; ?>" readonly /></th>
									</tr>
									<tr>
										<th>Roundoff</th>
										<th><input type="text" id="roundoff" name="roundoff" value="<?php echo $purchase["roundoff"]; ?>" readonly /></th>
									</tr>
									<tr>
										<th>Grand Total</th>
										<th><input type="text" id="grand_total" name="grand_total" value="<?php echo $purchase["grand_total"]; ?>" readonly /></th>
									</tr>
								</thead>
								<tbody>
								</tbody>
