		...
		<div class="row">
			<div class="col-lg-12">
				<div class="box box-primary">
					...
					<a href="<?php echo base_url(); ?>index.php/Home/addSale">
						<input class="btn btn-primary" type="button" value="Add New Sale"/>
					</a>
					<hr/>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a href="<?php echo base_url(); ?>index.php/Home/SalePrint?id=<?php echo $row["sale_id"];?>" target="_blank">
										<button type="button" class="btn btn-success">PRINT</button>
									</a> 
									
									
									<a href="<?php echo base_url(); ?>index.php/Home/updateSale?id=<?php echo $row["sale_id"];?>">
