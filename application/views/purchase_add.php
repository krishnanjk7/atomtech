...
.newproduct{
	...
	<section class="content-header">
		<h1>Purchase<small>Create</small></h1>
		<ol class="breadcrumb">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="box box-primary">
					...
					<form role="form" action="<?php echo base_url()."index.php/Home/addPurchase"; ?>" method="POST" id="purchase_form">
						<div class="box-body">
							...
							<table class="table table-bordered">
								<thead>
									...
									<tr>
										<th>Invoice No</th>
										<th><input type="text" name="invoice_no" required /></th>
										<th>Invoice Date</th>
